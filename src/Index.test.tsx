...
describe('application tests', () => {
  ...
  it('should render name: Shenaaz', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Shenaaz$/);
  });

  it('should render title: UI UX Developer', () => {
    const element = screen.getByTestId('title');

    checkContent(element, /^UI UX Developer$/);
  });
  ...
  it('should render link to source code', () => {
    ...
    checkContent(element, /^Source$/, 'https://github.com/Shenaazmulla');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/Shenaazmulla');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/mn-shenaaz-9932861b9/'
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:Shenaazmn@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Shenaaz\| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Shenaaz$/);
  });
